...
def VIDEOLINKS(name,url):
        ...
        for url in putlockera:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Putlocker[/B][/COLOR]',url,100,'','')
        ...
        for url in socksharea:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Sockshare[/B][/COLOR]',url,100,'','')
        ...
        for url in vidtoa:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Vidto[/B][/COLOR]',url,100,'','')
        ...
        for url in allmyvideosa:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - All My Videos[/B][/COLOR]',url,100,'','')
        allmyvideosb=re.compile('<iframe src="http://allmyvideos.net/([^"]*)" ', re.DOTALL).findall(link)
        for url in allmyvideosb:
                url = 'http://allmyvideos.net/' + url
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - AllMyVideos[/B][/COLOR]',url,100,'','')        
                
        vsharea=re.compile('<a href="http://vshare.eu/([^"]*)" target="_blank">Open video</a>', re.DOTALL).findall(link)
        for url in vsharea:
                url = 'http://vshare.eu/' + url
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Vshare[/B][/COLOR]',url,100,'','')
        ...
        for url in vidspota:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Vidspot[/B][/COLOR]',url,100,'','')
        ...
        for url in gorillaa:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Gorillavid[/B][/COLOR]',url,100,'','')
        ...
        for url in filenukea:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Filenuke[/B][/COLOR]',url,100,'','')
        ...
        for url in ishareda:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Ishared[/B][/COLOR]',url,100,'','')
        ...
        for url in youwatcha:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Youwatch[/B][/COLOR]',url,100,'','')
        ...
        for url in arkvida:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Arkvid[/B][/COLOR]',url,100,'','')
        ...
        for url in video44a:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Video44[/B][/COLOR]',url,100,'','')
        ...
        for url in mp4uploada:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Mp4upload[/B][/COLOR]',url,100,'','')
        ...
        for url in auenginea:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Auengine[/B][/COLOR]',url,100,'','')
        ...
        for url in vodlockera:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Vodlocker[/B][/COLOR]',url,100,'','')
        ...
        for url in vidbulla:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Vidbull[/B][/COLOR]',url,100,'','')
        ...
        for url in sharesixa:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Sharesix[/B][/COLOR]',url,100,'','')
        ...
        for url in vka:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - VK[/B][/COLOR]',url,100,'','')
        ...
        for url in nosvideoa:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Nosvideo[/B][/COLOR]',url,100,'','')
        ...
        for url in novamova:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Novamov[/B][/COLOR]',url,100,'','')
        ...
        for url in youtube:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Youtube[/B][/COLOR]',url,100,'','')
        ...
        for url in youtubepart2:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Youtube Part 2[/B][/COLOR]',url,100,'','')        
        ...
        for url in streamin:
                ...
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Streamin.to[/B][/COLOR]',url,100,'','')
        thefile=re.compile('http://thefile.me/embed-([^"]*?)-.+?.html', re.DOTALL).findall(link)
        for url in thefile:
                url = 'http://thefile.me/' + url
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Thefile[/B][/COLOR]',url,100,'','')
        exashare=re.compile('http://www.exashare.com/embed-([^"]*?)-.+?.html', re.DOTALL).findall(link)
        for url in exashare:
                url = 'http://www.exashare.com/' + url
                main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Exashare[/B][/COLOR]',url,100,'','')
        vidzi=re.compile('http://vidzi.tv/embed-([^"]*?)-.+?.html').findall(link)
        for url in vidzi:
               url='http://vidzi.tv/'+url
               main.addDownLink("[COLOR yellow]"+name+"[/COLOR]"+'[COLOR blue][B] - Vidzi[/B][/COLOR]',url,100,'','')
