...
slogo = xbmc.translatePath('special://home/addons/plugin.video.tvrule/resources/art/smallicon.png')
...
def addDirT(name,url,mode,iconimage,plot,fanart,dur,genre,year):
        ...
        Commands.append(('[B][COLOR=FF67cc33]TvRule[/COLOR] Settings[/B]','XBMC.RunScript('+xbmc.translatePath(tvrulepath + '/resources/libs/settings.py')+')'))
...
def addPlayc(name,url,mode,iconimage,plot,fanart,dur,genre,year):
        ...
        contextMenuItems.append(('[B][COLOR=FF67cc33]TvRule[/COLOR] Settings[/B]','XBMC.RunScript('+xbmc.translatePath(tvrulepath + '/resources/libs/settings.py')+')'))
...
def addInfo(name,url,mode,iconimage,gen,year):
        ...
        if selfAddon.getSetting("meta-view") == "true":
                ...
                xbmcplugin.addSortMethod( handle=int( sys.argv[ 1 ] ), sortMethod=xbmcplugin.SORT_METHOD_LABEL )
        Commands=[
                ('Search tvrule','XBMC.Container.Update(%s?mode=4&url=%s)'% (sys.argv[0],'m25')),
